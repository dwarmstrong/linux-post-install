...
local LINK2="https://www.circuidipity.com/openbox/"
...
DESCRIPTION
    ...
    first successful boot into a minimal install [1] of Debian's _testing_
    aka "$RELEASE" release.
    ...
    using Xorg and the lightweight _Openbox_ [2] window manager plus a range
    of desktop applications.
    
    Alternately, in lieu of a pre-defined list of Debian packages, the user may
    specify their own custom list of packages to be installed. [3]
OPTIONS
    -h              print details
...
SEE ALSO
    [1] "Minimal Debian"
        $LINK1
    [2] "Roll your own Linux desktop using Openbox"
        $LINK2
