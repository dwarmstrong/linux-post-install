#!/bin/bash
NAME="ubuntu-mate-after-install.sh"
BLURB="Configure a device after a fresh install of Ubuntu MATE"
SOURCE="https://github.com/vonbrownie/linux-post-install/tree/master/scripts/ubuntu-mate-after-install"
set -eu
...
DESCRIPTION
    ...
    successful boot into *Ubuntu MATE $RELEASE* [1].
